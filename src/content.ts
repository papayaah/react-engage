...
export const DEFAULT_ENGAGE_CONTENT: EngageWidgetContent = {
  ...
  feedback: {
    ...
    success: {
      ...
      feedbackMessage: 'Thank you for your feedback! We will review this to improve the app.',
      supportMessage: 'Thank you for reaching out. We will respond to your email shortly.',
